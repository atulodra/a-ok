...
//* Priority Sites
const prioritySites = ["vk.com/docs", "libgen.is", "libgen.is/fiction", "forum.mobilism.org"];
...
chrome.action.onClicked.addListener((tab)=>{
    ...
    //* Converts the old Tutflix io url to Tutflix org url
    if (tabURL.includes("tutflix.io")){
      const orgURL = tabURL.replace("io", "org");
      chrome.tabs.update(
        {
          "url": orgURL,
          "selected": true
